        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center gap-2">
                    <a href="{{ route('investitor.dashboard') }}" wire:navigate class="font-semibold text-lg text-gray-800 dark:text-gray-200">
                        Tabi <span class="text-emerald-600 dark:text-emerald-400">Investitor</span>
                    </a>
                </div>
